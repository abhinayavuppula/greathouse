...
import { LogIn, Mail, Lock, Eye, EyeOff, Loader2, Chrome, Github } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24">
        ...
        >
          ...
          <div className="relative my-10 text-center">
            ...
            <span className="relative px-4 bg-ivory text-[9px] uppercase tracking-widest text-charcoal/40">Or continue with</span>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 border border-charcoal/5 py-3 bg-white hover:bg-gold hover:text-white transition-all group">
              <Chrome size={16} className="opacity-70 group-hover:opacity-100" />
              <span className="font-accent text-[9px] tracking-widest uppercase">Google</span>
            </button>
            <button className="flex items-center justify-center gap-3 border border-charcoal/5 py-3 bg-white hover:bg-gold hover:text-white transition-all group">
              <Github size={16} className="opacity-70 group-hover:opacity-100" />
              <span className="font-accent text-[9px] tracking-widest uppercase">GitHub</span>
            </button>
          </div>

          <p className="mt-12 text-center font-body text-sm text-charcoal/60">
