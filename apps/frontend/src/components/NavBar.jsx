    ...
    <>
      ...
      >
        <div className="h-full px-6 md:px-12 flex items-center justify-between">
          ...
          {/* Desktop Links */}
          <div className="hidden md:flex items-center gap-7 font-body text-[11px] tracking-[0.15em] uppercase">
            ...
            <Link to="/idea-library" className="hover:text-gold transition-colors cursor-none relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] after:bg-gold hover:after:w-full after:transition-all after:duration-300">Ideas</Link>
            <Link to="/design-inspirations" className="hover:text-gold transition-colors cursor-none relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] after:bg-gold hover:after:w-full after:transition-all after:duration-300">Inspirations</Link>
            <Link to="/before-after" className="hover:text-gold transition-colors cursor-none relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] after:bg-gold hover:after:w-full after:transition-all after:duration-300">B&A</Link>
            <Link to="/case-studies" className="hover:text-gold transition-colors cursor-none relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] after:bg-gold hover:after:w-full after:transition-all after:duration-300">Cases</Link>
